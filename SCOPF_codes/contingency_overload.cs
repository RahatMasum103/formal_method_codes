...
namespace SCOPF
{
    class CaOpf
    {
        ...
        int nBuses, nLines, nMeasurements, nDBuses, nGBuses, nOverloads, nPercContgnCase, nPercContgnOverloadLine, numOfLinesOverloaded, numOfCasesOverLoaded;  // nBuses also represents the number of states               
